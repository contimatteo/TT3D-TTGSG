...
ln -s /media/data2/mconti/TT3D/checkpoints/TTGSG/generation/checkpoints/IM_AE.model32-499.pth generation/checkpoint/color_all_ae_64/IM_AE.model32-499.pth
